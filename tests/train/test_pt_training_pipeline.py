...
from bacpredict.sample_and_label.prepare_esmc_embeddings_and_labels_to_finetune_amr import (
    get_antibiotic_columns,
)
from bacpredict.train.split_utils import add_splits
from bacpredict.train.datasets import LabelInjectingFileDataset
from bacpredict.train.train_amr import PyTorchFileDataset
...
def test_pt_pipeline_imports():
    ...
    from bacpredict.sample_and_label import prepare_esmc_embeddings_and_labels_to_finetune_amr  # noqa: F401
    from bacpredict.train import train_amr  # noqa: F401
...
def test_kfold_validate_sets_non_overlapping():
    ...
    from bacpredict.train.split_utils import generate_kfold_splits
