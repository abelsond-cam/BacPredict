"""Unit tests for the full-eval attention-pool scorer (``snp_embeddings.eval_attn_pool_on_full_split``).
...
import snp_embeddings.eval_attn_pool_on_full_split as eafs
