"""Unit tests for the surprisal-panel builder (``snp_embeddings.build_surprisal_store``).
...
from snp_embeddings.build_surprisal_store import PANEL_DIM, PANEL_KEYS, panel_from_stats
