...
TB_SCRIPTS_DIR = REPO_ROOT / "src" / "bacpredict" / "apps" / "tb" / "scripts"
SHARED_DOWNLOAD_SCRIPTS_DIR = REPO_ROOT / "src" / "bacpredict" / "engine" / "download" / "scripts"
...
collect_bakrep = _load("tb_collect_bakrep_samples", TB_SCRIPTS_DIR)
download_assemblies = _load("download_assemblies", SHARED_DOWNLOAD_SCRIPTS_DIR)
