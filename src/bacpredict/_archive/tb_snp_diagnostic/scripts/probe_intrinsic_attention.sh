...
#
#   sbatch src/pangena_predict/scripts/probe_intrinsic_attention.sh frozen - 20                 # frozen smoke
#   sbatch src/pangena_predict/scripts/probe_intrinsic_attention.sh frozen                      # frozen full
#   sbatch src/pangena_predict/scripts/probe_intrinsic_attention.sh e2e_gated_mil_0868 /path/ckpt  # FT full (D2)
...
OUT_DIR=$RDS/pangena_predict/intrinsic_attention/$LABEL
...
uv run python src/pangena_predict/intrinsic_attention_probe.py \
