...
#
# Usage:  sbatch src/pangena_predict/scripts/unmasked_surprisal_analysis.sh   # after the array
#
...
POINTS_NPZ=$RDS/pangena_predict/llr_distribution_probe/llr_phase0_0a_30535846_0a_points.npz
mkdir -p "$ANALYSIS_DIR"

uv run python src/pangena_predict/surprisal_analysis.py \
