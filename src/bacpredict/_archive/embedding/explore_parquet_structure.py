...
def explore_parquet_file(filepath):
    ...
    except Exception as e:  # noqa: BLE001 (robustness: report the unreadable file and skip it)
...
def main():
    """Sample a few ESMC embedding parquet files and print their structure."""
    # Constants
    data_dir = DATA_DIR
