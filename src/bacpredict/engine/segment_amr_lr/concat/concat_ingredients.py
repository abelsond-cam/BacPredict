...
per-gene token stores. These were copy-pasted across the concat drivers (``reliable_concat``, ``concat_segment_panel``,
``segment_ingredient_concat``, all now under :mod:`bacpredict.engine.segment_amr_lr.concat`); they live here once.
"""
