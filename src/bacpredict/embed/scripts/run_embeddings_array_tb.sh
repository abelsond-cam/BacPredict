...
#
# Usage:
#   sbatch src/bacpredict/embed/scripts/run_embeddings_array_tb.sh
#   sbatch --array=0-127 --time=02:00:00 src/bacpredict/embed/scripts/run_embeddings_array_tb.sh
