...
python_script="src/bacpredict/sample_and_label/prepare_esmc_embeddings_and_labels_to_finetune_isolation_source.py"
...
# ESM embeddings
# uv run python src/bacpredict/sample_and_label/prepare_esmc_embeddings_and_labels_to_finetune_amr.py --skip-existing
#uv run python src/bacpredict/genome_download/add_paths_gff_fna_to_metadata.py
