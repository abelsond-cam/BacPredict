...
The ``mode="frozen"`` counterpart of :mod:`bacpredict.apps.kleb.cache_ft_amr_proteins`. Identical extraction — one forward
...
(:mod:`bacpredict.apps.kleb.gene_ingredient_concat`): is the **frozen-Bacformer gene**, the **frozen-ESM gene**, or the
