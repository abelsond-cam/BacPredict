...
Engine driver: :mod:`bacpredict.engine.concat.gene_ingredient_concat`. The compute — (frozen/FT genome-mean) × (ESM / frozen-Bac / FT-Bac best gene) concat scoring — is
...
from bacpredict.engine.concat.gene_ingredient_concat import run
