...
# bacpredict.engine.gene_lr.build_per_gene_lr_store; only the paths + drug list change). For every gene present in
...
#
# Usage:  sbatch src/bacpredict/apps/kleb/scripts/build_per_gene_lr_ranking.sh
#
...
OUT=$D/processed/train_kleb_ast/pangena_predict/per_gene_lr_ranking/$DRUG
