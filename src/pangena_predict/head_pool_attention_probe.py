...
The companion :mod:`pangena_predict.intrinsic_attention_probe` measures Bacformer's **own**
...
flat-index machinery of :mod:`pangena_predict.bacformer_genome_vectors` and the ``_rank_stats``
ranking of :mod:`pangena_predict.intrinsic_attention_probe`.
"""
...
from pangena_predict.intrinsic_attention_probe import _rank_stats, _resolve_weight_checkpoint, load_attn_pool_wrapper
...
def load_attn_pool_checkpoint(checkpoint_dir: str, device: str) -> torch.nn.Module:
    ...
    by :func:`~pangena_predict.intrinsic_attention_probe.load_attn_pool_wrapper`
