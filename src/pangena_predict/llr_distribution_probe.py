...
ESM-C MLM). Reuses :func:`pangena_predict.snp_vs_esm_prediction.resolve_clean_splits`,
:func:`pangena_predict.rpob_genotype.build_genotype_table` /
:func:`~pangena_predict.rpob_genotype.sample_codon_positions`,
:func:`pangena_predict.locate_gene.flatten_proteins`, and
