...
#
# Usage:  sbatch src/pangena_predict/scripts/llr_distribution_probe.sh 0a   # n=100 proxy proof
#         sbatch src/pangena_predict/scripts/llr_distribution_probe.sh 0b   # cross-4000 flag
#
...
OUT_DIR=$RDS/pangena_predict/llr_distribution_probe
...
uv run python src/pangena_predict/llr_distribution_probe.py \
