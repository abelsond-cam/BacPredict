...
#
#   sbatch src/pangena_predict/scripts/probe_head_pool_attention.sh /path/ckpt e2e_gated_mil_0868 20   # smoke
#   sbatch src/pangena_predict/scripts/probe_head_pool_attention.sh /path/ckpt e2e_gated_mil_0868       # full
...
OUT_DIR=$RDS/pangena_predict/head_pool_attention/$LABEL
...
uv run python src/pangena_predict/head_pool_attention_probe.py \
