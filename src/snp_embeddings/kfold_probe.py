...
seed)`` on the one fixed evaluate holdout with :func:`snp_embeddings.snp_vs_esm_prediction.fit_score_step`,
...
from snp_embeddings.snp_vs_esm_prediction import fit_score_step
