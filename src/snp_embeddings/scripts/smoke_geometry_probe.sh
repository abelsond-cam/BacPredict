...
#
# Usage:  sbatch src/snp_embeddings/scripts/smoke_geometry_probe.sh
#
...
OUT_DIR=/home/dca36/rds/rds-floto-bacterial-4k08a2yyQLw/david/processed/train_tb_ast/snp_embeddings/geometry_probe_smoke
...
uv run python src/snp_embeddings/geometry_probe.py \
