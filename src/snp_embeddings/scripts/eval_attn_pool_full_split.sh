...
#
#   sbatch src/snp_embeddings/scripts/eval_attn_pool_full_split.sh \
...
OUT_DIR=$RDS/snp_embeddings/full_eval_attn_pool/$LABEL
...
uv run python src/snp_embeddings/eval_attn_pool_on_full_split.py \
