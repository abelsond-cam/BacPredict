...
#
#   sbatch src/snp_embeddings/scripts/build_per_gene_lr_panel_store.sh
#
...
# Pin BLAS to 1 thread/process so the 8 joblib workers (one per-gene LR each) don't oversubscribe.
