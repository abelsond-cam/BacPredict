...
#
# Usage:  sbatch --dependency=afterok:<ranking_jobid> src/snp_embeddings/scripts/run_concat_frozen_sweep.sh
#
...
RANKING=$RDS/snp_embeddings/per_gene_lr_ranking/$DRUG/per_gene_lr_${DRUG}.csv
BAC_NPZ=$RDS/snp_embeddings/concat_rpob_mean/frozen_bacformer_vectors_30632514.npz  # drug-agnostic frozen mean
OUT_DIR=$RDS/snp_embeddings/concat_drug_sweep
