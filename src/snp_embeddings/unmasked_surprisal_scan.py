...
The Phase-0 probe (:mod:`snp_embeddings.llr_distribution_probe`) established, on rpoB,
...
2. **Per-protein concentration statistics** — which summary best isolates the single-SNP
   ...
   :func:`~snp_embeddings.llr_distribution_probe.protein_surprisal_stats` row is written to
...
from snp_embeddings.llr_distribution_probe import (
    _NEEDED_COLS,
    hotspot_codons,
    hotspot_label,
